...
//
//
//    public void fromWebsite(String website, Integer numberForecast) {
...
//
//            if(numberForecast <= 0 || numberForecast == null){
//                numberForecast = DEFAULT_NUMBER_FORECAST;
//            }
//            for (int forecastDay = 0; forecastDay < numberForecast; forecastDay++) {
//                int row = START_ROW + forecastDay;
//                List<WeatherHourly> listStationHourlyData = query.getDataHourly(station.getStationCode(), website, forecastDay);
//
//                Cell cell = null;
...
//        try {
//
//            Utils.checkAndCreateNewFile(OUT_FILENAME);
